...
from refseg.models.models import RefSegEncoderDecoder, RefSegSiglipTextModel, \
    RefSegSiglipVisionModel, RefSegSam, CascadedPrompter, PseudoSegHead

default_scope = 'mmseg'
custom_imports = dict(imports=['refseg'], allow_failed_imports=False)


work_dir = f'./work_dirs/risbench'
data_root = f'/mnt/ali-sh-1/dataset/cky_data/RISBench_dataset/img_rgb'
...
vis_backends = [
    ...
    # dict(type=WandbVisBackend, init_kwargs=dict(project='RefSeg', group='risbench-l', name=work_dir.split('/')[-1]))
]
...
# init_from = dict(
#     type='Pretrained',
#     checkpoint='work_dirs/RSRefSeg-b/epoch_85.pth/mp_rank_00_model_states.pth'
# )
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='datainfo/risbench_train.jsonl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='datainfo/risbench_test.jsonl',
